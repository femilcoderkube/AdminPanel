...
const Header = () => {
  const { setToggleMenu, setMenuVisible } = useAppContext();
  ...
  return (
    ...
    >
      <div
        ...
        className="app-container container-fluid container-fluid container-fluid d-flex align-items-stretch justify-content-between bg-white shadow-sm"
      >
        <div
        ...
        >
          ...
          <div className="app-navbar flex-shrink-0">
              ...
              >
                ...
                >
                    ...
                    <div data-kt-search-element="results" className="d-none">
                      <div className="scroll-y mh-200px mh-lg-350px">
                        ...
                        >
                          <div className="symbol symbol-40px me-4">
                            <img
                              src="/metronic8/react/demo1/media/avatars/300-14.jpg"
                              alt=""
                            />
                          </div>
                          <div className="d-flex flex-column justify-content-start fw-bold">
                          ...
                          <div className="symbol symbol-40px me-4">
                            <span className="symbol-label bg-light">
                              <img
                                ...
                                src="/metronic8/react/demo1/media/svg/brand-logos/volicity-9.svg"
                                alt=""
                              />
                            </span>
                          </div>
                        ...
                        >
                          <div className="symbol symbol-40px me-4">
                            <span className="symbol-label bg-light">
                              <img
                                className="w-20px h-20px"
                                src="/metronic8/react/demo1/media/svg/brand-logos/tvit.svg"
                                alt=""
                              />
                            </span>
                          </div>
                        ...
                        >
                          <div className="symbol symbol-40px me-4">
                            <span className="symbol-label bg-light">
                              <img
                                className="w-20px h-20px"
                                src="/metronic8/react/demo1/media/svg/misc/infography.svg"
                                alt=""
                              />
                            </span>
                          </div>
                        ...
                        >
                          <div className="symbol symbol-40px me-4">
                            <span className="symbol-label bg-light">
                              <img
                                className="w-20px h-20px"
                                src="/metronic8/react/demo1/media/svg/brand-logos/leaf.svg"
                                alt=""
                              />
                            </span>
                          </div>
                        ...
                        >
                          <div className="symbol symbol-40px me-4">
                            <span className="symbol-label bg-light">
                              <img
                                className="w-20px h-20px"
                                src="/metronic8/react/demo1/media/svg/brand-logos/tower.svg"
                                alt=""
                              />
                            </span>
                          </div>
                  ...
                  <form className="pt-1 d-none">
                    <h3 className="fw-bold text-gray-900 mb-7">
                      Advanced Search
                    </h3>
                    <div className="mb-5">
                      <input
            ...
            <div className="app-navbar-item ms-1 ms-md-4">
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url("/metronic8/react/demo1/media/misc/menu-header-bg.jpg")',
                  }}
                >
                  ...
                  <ul
                    className="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-bold px-9"
                    role="tablist"
                  >
                    ...
                    <div className="d-flex flex-column px-9">
                      ...
                      <div className="text-center px-4">
                        <img
                          ...
                          alt="metronic"
                          src="/metronic8/react/demo1/media/illustrations/sketchy-1/1.png"
                        />
                      </div>
                    </div>
                  </div>
            ...
            <div className="app-navbar-item ms-1 ms-md-4">
              ...
              >
                <img
                  src="/metronic8/react/demo1/media/avatars/300-3.jpg"
                  alt=""
                />
              </div>
              <div
                    ...
                    <span className="menu-title position-relative">
                      ...
                      <span className="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                        ...
                        <img
                          ...
                          src="/metronic8/react/demo1/media/flags/united-states.svg"
                          alt="metronic"
                        />
                      </span>
                    </span>
                    ...
                    <div className="menu-item px-3">
                      <a href="#" className="menu-link d-flex px-5">
                        <span className="symbol symbol-20px me-4">
                          <img
                            className="rounded-1"
                            src="/metronic8/react/demo1/media/flags/china.svg"
                            alt="metronic"
                          />
                        </span>
                        Mandarin
                    ...
                    <div className="menu-item px-3">
                      <a href="#" className="menu-link d-flex px-5">
                        <span className="symbol symbol-20px me-4">
                          <img
                            className="rounded-1"
                            src="/metronic8/react/demo1/media/flags/spain.svg"
                            alt="metronic"
                          />
                        </span>
                        Spanish
                    ...
                    <div className="menu-item px-3">
                      <a href="#" className="menu-link d-flex px-5">
                        <span className="symbol symbol-20px me-4">
                          <img
                            className="rounded-1"
                            src="/metronic8/react/demo1/media/flags/japan.svg"
                            alt="metronic"
                          />
                        </span>
                        Japanese
                    ...
                    <div className="menu-item px-3">
                      <a href="#" className="menu-link d-flex px-5">
                        <span className="symbol symbol-20px me-4">
                          <img
                            className="rounded-1"
                            src="/metronic8/react/demo1/media/flags/germany.svg"
                            alt="metronic"
                          />
                        </span>
                        German
                    ...
                    <div className="menu-item px-3">
                      <a href="#" className="menu-link d-flex px-5">
                        <span className="symbol symbol-20px me-4">
                          <img
                            className="rounded-1"
                            src="/metronic8/react/demo1/media/flags/france.svg"
                            alt="metronic"
                          />
                        </span>
                        French
